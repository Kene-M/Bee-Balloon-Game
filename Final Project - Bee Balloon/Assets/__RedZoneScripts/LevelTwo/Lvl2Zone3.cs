...
public class Lvl2Zone3 : MonoBehaviour
{
    ...
    private void Start()
    {
        pointA = new Vector3(transform.position.x, 9f, transform.position.z);
        pointB = new Vector3(transform.position.x, -9f, transform.position.z);
        targetPoint = pointB;
    }
