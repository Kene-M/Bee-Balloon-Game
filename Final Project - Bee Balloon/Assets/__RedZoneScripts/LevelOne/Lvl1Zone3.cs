...
public class Lvl1Zone3 : MonoBehaviour
{
    ...
    private void Start()
    {
        pointA = new Vector3(-11f, transform.position.y, transform.position.z);
        pointB = new Vector3(-7.08f, transform.position.y, transform.position.z);
        targetPoint = pointB;
    }
